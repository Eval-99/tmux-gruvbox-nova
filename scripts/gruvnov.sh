...
gruvnov_fg='#1d2122 bold'
gruvnov_bg='#ebdbb2'
gruvnov_alt='#928374'
gruvnov_red='#fb4934 bold'
gruvnov_gre='#b8bb26'
gruvnov_yel='#fabd2f'
gruvnov_blu='#83a598'
gruvnov_pur='#d3869b'
...
upsert_option "@gruvnov-segment-mode" "#{?client_prefix,,}"
upsert_option "@gruvnov-segment-whoami" "#(whoami)@#h"
...
message_command_style_bg=$(get_option "@gruvnov-message-command-style-bg" "#44475a")
message_command_style_fg=$(get_option "@gruvnov-message-command-style-fg" "#f8f8f2")
tmux set-option -g message-command-style "bg=$message_command_style_bg,fg=$message_command_style_fg"

message_style_bg=$(get_option "@gruvnov-message-style-bg" "#282a36")
message_style_fg=$(get_option "@gruvnov-message-style-fg" "#f8f8f2")
tmux set-option -g message-style "bg=$message_style_bg,fg=$message_style_fg"

mode_style_bg=$(get_option "@gruvnov-mode-style-bg" "#44475a")
mode_style_fg=$(get_option "@gruvnov-mode-style-fg" "#f8f8f2")
...
status_style_fg=$(get_option "@gruvnov-status-style-fg" "$gruvnov_red")              # Used to be #f8f8f2
status_style_active_bg=$(get_option "@gruvnov-status-style-active-bg" "$gruvnov_bg") # Used to be #6272a4
status_style_active_fg=$(get_option "@gruvnov-status-style-active-fg" "$gruvnov_fg") # Used to be #f8f8f2
...
first_left_nerdfont=$(get_option "@gruvnov-nerdfonts-first" "")
